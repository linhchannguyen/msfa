<template>
  <div class="modal-approve">
    <h2 class="approve-title text-center">差し戻しますか？</h2>
    ...
    <div class="approveForm-btn text-center">
      ...
      <button type="button" class="btn btn-outline-danger" @click="remandConvention()">差戻</button>
    </div>
  </div>
</template>
<script>
...
export default {
  name: 'C01_S02_LectureInputRemand',
  components: {},
  props: {},
