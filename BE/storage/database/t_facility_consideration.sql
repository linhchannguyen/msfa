DROP TABLE IF EXISTS `t_facility_consideration`;

CREATE TABLE `t_facility_consideration` (
   `facility_consideration_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '注意事項ID',
   ...
   constraint `t_facility_consideration_PKC` PRIMARY KEY (`facility_consideration_id`)
 ) COMMENT='施設注意事項' ENGINE=InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_general_ci ;