    ...
    <tbody>
        @if(count($attendees['datas']) > 0)
            @foreach ($attendees['datas'] as $datas)
                <tr>
                    <td style="border:1px solid black;text-align:left;">{{ $datas['facility_cd'] }}</td>
                    <td style="border:1px solid black;text-align:left;">{{ $datas['facility_name'] }}</td>
                    <td style="border:1px solid black;text-align:left;">{{ $datas['department_cd'] }}</td>
                    <td style="border:1px solid black;text-align:left;">{{ $datas['department_name'] }}</td>
                    <td style="border:1px solid black;text-align:left;">{{ $datas['display_position_cd'] }}</td>
                    <td style="border:1px solid black;text-align:left;">{{ $datas['display_position_name'] }}</td>
                    <td style="border:1px solid black;text-align:left;">{{ $datas['person_cd'] }}</td>
                    <td style="border:1px solid black;text-align:left;">{{ $datas['person_name'] }}</td>
