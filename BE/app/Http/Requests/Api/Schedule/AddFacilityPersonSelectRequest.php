...
class AddFacilityPersonSelectRequest extends ApiBaseRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'content_name_tran' => 'nullable|max:50',
            'product_list.*.product_cd' => 'nullable|max:10',
            'product_list.*.product_name' => 'nullable|max:30',
            'document_list.*.document_id' => 'nullable|max:15',
        ];
    }
