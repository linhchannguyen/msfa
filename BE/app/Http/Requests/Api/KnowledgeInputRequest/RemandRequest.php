...
class RemandRequest extends ApiBaseRequest
{
    /**
    ...
    public function rules()
    {
        ...
        if (count($this->comment_remand ?? []) > 0) {
            $rules['comment_remand.layer_num'] = ['required'];
            $rules['comment_remand.approval_user_cd'] = ['required'];
            $rules['comment_remand.comment'] = ['nullable' , 'max:200'];
        }
    ...
    public function messages()
    {
        return [
            ...
            'comment_remand.layer_num' => [
                'required' => __('validation.required'),
            ],
            'comment_remand.approval_user_cd' => [
                'required' => __('validation.required'),
            ],
            'mode_screen' => [
                'required' => __('validation.required'),
    ...
    public function attributes()
    {
        return [
            ...
            'comment_remand' => 'コメント差し戻し',
            'comment_remand.layer_num' => '承認階層',
            'comment_remand.approval_user_cd' => 'ユーザコード（承認者）',
            'comment_remand.comment' => 'コメント',
            'mode_screen' => 'モード画面',
            'users' => 'ユーザー',
