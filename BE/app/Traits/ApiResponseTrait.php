...
trait ApiResponseTrait
{
    ...
    {
        saveInfoLog('VALIDATE', 401, '', NULL, $data);
        return response()->json(
            [
                'status' => $code,
                'message' => $message,
    ...
    public function responseErrorValidate(string $message, $data = [])
    {
        ...
        saveInfoLog('VALIDATE', 400, '', NULL, $data);
    ...
    public function responseErrorForbidden(string $message, $data = [])
    {
        saveInfoLog('PROCESS', 403, '', NULL, $data);
        return $this->response(self::$status_forbidden, $message, $data);
    }
    ...
    public function responseNotFoundValidate(string $message, $data = [])
    {
        saveInfoLog('VALIDATE', 404, '', NULL, $data);
        return $this->response(self::$status_not_found, $message, $data);
    }
